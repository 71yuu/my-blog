    ...
    <table class="layui-table" >
        ...
        <c:forEach items="${linkList}" var="l">
            <tr>
                ...
                <td>
                    <fmt:formatDate value="${l.linkCreateTime}" pattern="yyyy年MM月dd日"/>
                </td>
                <td>
                        ${l.linkOrder}
                </td>
                ...
                <td>
                    ...
                    <a href="javascript:;" class="layui-btn layui-btn-danger layui-btn-mini" onclick="confirmDelete('/admin/link/delete/', ${l.linkId}, '/admin/link')">删除</a>
                </td>
                <td>${l.linkId}</td>
            </tr>
