        ...
        <div id="feed_widget">
            <div class="feed-about">
                ...
                <ul>
                    ...
                    <li class="feed">
                        <a title="" href="https://blog.csdn.net/${options.optionAboutsiteGithub}" target="_blank"
    ...
    <aside id="php_text-22" class="widget php_text">
        ...
        <div class="textwidget widget-text">
            <ul class="site-profile">
                ...
                <li><i class="fa fa-tags"></i> 标签总数：${siteBasicStatistics[2]} 个</li>
                <li><i class="fa fa-eye"></i> 浏览总量：${siteBasicStatistics[3]} 次</li>
