...
<rapid:override name="content">
    ...
    <div class="layui-row">
        <div class="layui-col-md4">
            <form class="layui-form"  method="post" id="myForm" action="/admin/menu/save">
                <div class="layui-form-item">
                    <div class="layui-input-block">
                        <strong>${menu.menuId == null ? "新增" : "编辑"}菜单项目</strong>
                    </div>
                    <input type="hidden" name="menuId" value="${menu.menuId}"/>
                    <div class="layui-input-block">
                        名称
                        <span style="color: #FF5722; ">*</span>
                        <input type="text" name="menuName" placeholder="如：如留言板" value="${menu.menuName}" autocomplete="off" class="layui-input" required>
                    </div>
                    <br>
                    <div class="layui-input-block">
                        URL
                        <span style="color: #FF5722; ">*</span>
                        <input type="text" name="menuUrl" placeholder="如：http://www.yyhsite.xin" value="${menu.menuUrl}" autocomplete="off" class="layui-input" required>
                    </div>
                    <br>
                    <div class="layui-input-block">
                        图标
                        <input type="text" name="menuIcon" placeholder="如：fa fa-comment" value="${menu.menuIcon}" autocomplete="off" class="layui-input" >
                    </div>
                    <br>
                    <div class="layui-input-block">
                        菜单位置
                    ...
                    <div class="layui-input-block">
                        Order
                        <input type="number" name="menuOrder" value="${menu.menuOrder == null ? 1 : menu.menuOrder}"class="layui-input" min="1" max="10" >
                    </div>
                    <br>
                    <div class="layui-input-block">
                                ...
                                <c:if test="${m.menuLevel == 1}">
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="javascript:;" class="layui-btn layui-btn-danger layui-btn-mini" title="点击删除" onclick="confirmDelete('/admin/menu/delete/', ${m.menuId} , '/admin/menu')">删除</a>
                                        </td>
                                        <td >${m.menuId}</td>
                                    </tr>
                                </c:if>
