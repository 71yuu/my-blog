    ...
    <div class="layui-row">
                ...
                <div class="inside">
                    <div id="activity-widget">
                        <div id="published-posts" class="activity-block"><h3>最近发布</h3> <br>
                            <ul>
                                <c:forEach items="${articleList}" begin="0" end="4" step="1" var="article">
                                    <c:if test="${article.articleStatus == 1}">
                                    <li>
                                        <span><fmt:formatDate value="${article.articleCreateTime}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
                                    ...
                                    <c:if test="${article.articleStatus == 0}">
                                        <li>
                                            <span><fmt:formatDate value="${article.articleCreateTime}" pattern="yyyy-MM-dd HH:mm:ss"/></span>
                                            <a href="/admin/article/edit/${article.articleId}" target="_blank">${article.articleTitle}</a>
                                            <span style="float: right;">草稿</span>
                                        </li>
                                    </c:if>
                                </c:forEach>
                            </ul>
        ...
        <div class="layui-col-md6">
            <div id="dashboard_quick_press" class="postbox ">
                <div class="inside">
                    <form class="initial-form hide-if-no-js layui-form" id="insertDraftForm" method="post" action="/admin/article/insertDraftSubmit">
                        ...
                        <div class="layui-form-item layui-form-text">
                            <div class="layui-input-block">
                                <textarea name="articleHtml" required lay-verify="required" placeholder="请输入内容" id="articleHtml" class="layui-textarea"></textarea>
                            </div>
                        </div>
                                ...
                                <c:if test="${article.articleStatus == 0}">
                                    <li>
                                        <div class="draft-title">
                                            <a href="/admin/article/edit/${article.articleId}">${article.articleTitle}</a>
                                            <time><fmt:formatDate value="${article.articleCreateTime}" pattern="yyyy-MM-dd HH:mm:ss"/> </time>
                                        </div>
                                    </li>
                                </c:if>
                            </c:forEach>
